...
import static data.scripts.JunkPiratesModPlugin.isIndEvo;
import data.scripts.world.addMarketPlace;
import java.util.ArrayList;
import java.util.Arrays;

public class Brehinni {
    private static final String INDEVO_ACADEMY = "IndEvo_Academy";
	...
	public void generate(SectorAPI sector) {
		...
		SectorEntityToken brehinni_nebula = Misc.addNebulaFromPNG("data/campaign/terrain/brehinni_nebula.png",
		...
		milStation.setInteractionImage("illustrations", "karkov_academy");
                ...
                if (isIndEvo) {
                    milStation.getMarket().addIndustry(INDEVO_ACADEMY);
                }
